...
import { UserPlus, Mail, Eye, EyeOff, User, ArrowRight } from "lucide-react";
...
export default function Signup() {
  ...
  const { mutate: doSignup, isPending } = useAuthSignup();
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="w-[800px] h-[800px] rounded-full bg-primary/5 blur-3xl opacity-50 absolute -top-40 -right-40" />
        <div className="w-[600px] h-[600px] rounded-full bg-accent/5 blur-3xl opacity-50 absolute bottom-0 left-0" />
      </div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <p className="mt-2 text-center text-sm text-muted-foreground">
          Start extracting visiting cards in seconds
        </p>
      </div>
